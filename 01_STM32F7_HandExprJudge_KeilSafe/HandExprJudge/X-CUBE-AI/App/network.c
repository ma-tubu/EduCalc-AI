...
#define AI_NETWORK_MODEL_SIGNATURE     "0x5d7b8d3c571653eeaba8c81441ea35bf"
...
#define AI_TOOLS_DATE_TIME   "2026-06-22T23:15:35+0800"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_image0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #19 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_image0_output, AI_STATIC,
  19, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 28, 28), AI_STRIDE_INIT(4, 4, 4, 4, 112),
  1, &serving_default_image0_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_image0_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 209852, 1, 1),
    209852, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 10516, 1, 1),
    10516, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_image0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_7_output),
  &conv2d_0_layer, 0x82aa070f, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_image0_output_array.data = AI_PTR(g_network_activations_map[0] + 5552);
    serving_default_image0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5552);
    conv2d_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 8688);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 8688);
    conv2d_0_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 8724);
    conv2d_0_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 8724);
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 1088);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1088);
    conv2d_2_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 7360);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 7360);
    conv2d_2_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 7648);
    conv2d_2_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 7648);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 205696);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 205696);
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 205952);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 205952);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 209792);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 209792);
    return true;
  }

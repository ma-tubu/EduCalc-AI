...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 10516, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (10516)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (10516)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 209852, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (209852)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (209852)
